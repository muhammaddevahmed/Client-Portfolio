 document.addEventListener('DOMContentLoaded', function() {
            ...
            function movePrev() {
                if (currentIndex > 0) {
                    // Move back by exactly 3 projects on desktop, 2 on tablet, 1 on mobile
                    const moveBy = window.innerWidth >= 1024 ? 3 : 
            ...
            function moveNext() {
                if (currentIndex < projects.length - projectsPerView) {
                    // Move forward by exactly 3 projects on desktop, 2 on tablet, 1 on mobile
                    const moveBy = window.innerWidth >= 1024 ? 3 : 
                                 window.innerWidth >= 768 ? 2 : 1;
            ...
            document.addEventListener('click', function(e) {
                ...
                if (projectContainer) {
                    ...
                    alert(`Opening Project ${projectNumber} details`);
                    setTimeout(() => {
                        const projectPages = {
                            1: 'ecommerce-project.html',
                            2: 'kadots-project.html',
                            3: 'earbuds-project.html',
                            4: 'task-management.html',
                            5: 'recipe-finder.html'
                        };
